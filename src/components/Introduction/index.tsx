...
const Introduction: React.FC = () => {
  return (
    <>
    <div className="hidden sm:block trapezium-background"></div>
      <div className="w-full flex justify-center mt-8">
        <p className="text-2xl sm:text-5xl font-bold mb-4 text-center">
          Find Your Perfect Courses & Improve Your Skills
        </p>
      </div>
      <div className="mt-3 introduction-container p-4 flex flex-col sm:flex-row items-center justify-evenly rounded-lg">
        <div className="text-content flex-1 space-y-6 sm:w-3/5 sm:space-y-12">
          <p className="text-sm sm:text-xl mb-4 text-center sm:text-left">
            Comprehensive video lectures, student success stories and
            personalized learning experience to help excel in your journey.
          </p>
        ...
        <div
          className="image-content relative sm:block overflow-hidden sm:w-2/5 place-items-end mb-4 mr-4"
          style={{ height: "350px" }}
        >
          <Image
            src={SKJImage}
          ...
          />
          <div className="hidden sm:block shadow-xl rounded-2xl  absolute bottom-0 right-5 m-2 hover:transform hover:scale-105 transition-transform duration-300">
            <InfoBadge2 />
          </div>
          <div className="hidden shadow-xl rounded-2xl sm:block infobadge-2 top-10 absolute m-2 hover:transform hover:scale-105 transition-transform duration-300">
            <InfoBadge />
          </div>
          <div className=" shadow-xl rounded-2xl absolute bottom-5 left-0 m-2 hover:transform hover:scale-105 transition-transform duration-300">
            <InfoBoxWithArrow />
          </div>
        </div>
      </div>
