...
const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  return (
    <div className="max-w-sm mx-auto bg-white rounded-lg shadow-md p-3 h-64 transform transition-transform duration-300 hover:scale-105">
      ...
      <p className="text-gray-800 h-full">
        &quot;
        {isExpanded ? testimonial : `${testimonial.slice(0, characterLimit)}...`}
